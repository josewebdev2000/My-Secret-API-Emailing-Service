...
class TestEmailingService(unittest.TestCase):
    ...
    def test_raise_missing_key_information_exception(self):
        ...
        print("\nCase 2: Raise Exception from trying to send email without key information")
    ...
    def test_raise_invalid_email_exception(self):
        ...
        print("\nCase 3: Raise Exception from trying to send an email without a receiver")
    ...
    def test_send_successful_html_email_no_placeholders(self):
        ...
        print("\nCase 4: Successfully send HTML email without placeholders")
    ...
    def test_send_successful_html_email_with_placeholders(self):
        ...
        print("\nCase 5: Successfully send HTML email with placeholders")
